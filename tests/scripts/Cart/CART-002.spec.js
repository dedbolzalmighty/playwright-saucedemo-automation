...
test.describe('Product Cart Funtionality', () =>{
    ...
    test.beforeEach(async({page}) =>{
        ...
        test('Verify if "Continue shopping" button is functional.',async({page})=>{
            ...
            //Step 4: Verify if Continue shipping button is functional.
            await page.getByRole('link', { name: 'Continue Shopping'}).click();

            //Step 5: Veriofy if the user is navigated back to the product page
